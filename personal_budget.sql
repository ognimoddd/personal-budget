...
(9, 'test', 'Holiday Budget', 'Trip to Peru', 3000, 'USD'),
...
(14, 'Housing Loan', 'Bank Millenium SA', 'debt', 247000, 'test', 'PLN'),
(15, 'Car Loan', 'Mama', 'debt', 11830, 'test', 'USD'),
(16, 'Dan's Debt', 'Daniel Chung', 'claim', 3054, 'test', 'USD'),
(17, 'Car Repair Loan', 'Chris Keller', 'claim', 2683, 'test', 'USD');
...
(3, 9, 7000, 'Accommodation'),
(9, 11, 200, 'Fuel'),
(10, 11, 500, 'Food'),
(8, 11, 900, 'Home Furnishings'),
(7, 11, 1800, 'Deposit for Apartment');
...
('Entertainment', 'Cinema, Buying Gadgets', 'test'),
('Sport', 'Gym, rower, Fishing, itp.', 'test'),
('Car Expenses', 'Fuel, Repairs, Insurance, itd.', 'test'),
